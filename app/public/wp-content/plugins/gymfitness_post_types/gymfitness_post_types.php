...
function gymfitness_clases_post_type() {
	...
	$labels = array(
		...
		'add_new_item'          => __( 'Añadir Clase', 'gymfitness' ),
		'add_new'               => __( 'Añadir Clase', 'gymfitness' ),
	...
	$args = array(
		...
		'hierarchical'          => true, // true = posts (no padre), false = páginas
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
        'menu_position'         => 6, // 5 Entradas y luego van aumentando de 5 en 5 (6 la opción aparecería en el menú después de Entradas)
